...
<?php
	class cart
	{
		...
		public function add_to_cart($quantity,$id){
			...
			// if($check_cart){
			// 	$msg = "Sản phẩm đã có trong giỏ hàng rồi";
			// 	return $msg;
			// }else{
		...
		public function upadte_quantity_cart($quantity, $cartId){
		...
		// 		header('Location:cart.php');
		// 	}else{
		// 		$msg = "<span class='error'>Xóa số lượng sản phẩm không thành công</span>";
		// 		return $msg;
		// 	}
		}
		...
		public function del_shifted($id,$price){
		...
		public function shifted_confirm($id,$price){
			...
			$query = "UPDATE tbl_order SET
					...
					WHERE customer_id = '$id' AND price = '$price'";
			$result = $this->db->update($query);
			return $result;
